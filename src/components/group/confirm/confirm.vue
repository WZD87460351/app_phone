    ...
    <div class="page">
        ...
        <div class="container">
            ...
            <ul class="exhibition">
                ...
                <li class="exhibition-cell" v-if="set.ishead==1&&set.is_head==1&&set.discount==1&&goodsInfo.headsmoney>0&&goodsInfo.headstype==0">
                    <div class="exhibition-lf">
                        团长优惠
                    </div>
                    <span class="mygoods-price">
                 ...
                 <li class="exhibition-cell" v-if="set.ishead==1&&set.is_head==1&&set.discount==1&&goodsInfo.headsmoney>0&&goodsInfo.headstype==1">
                    <div class="exhibition-lf">
