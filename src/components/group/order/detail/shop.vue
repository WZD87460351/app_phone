<template>
    <div class="shop">
        <div class="shop-title"><span class="icon-shop">&#xe6a8;</span> {{shop.name}}</div>
        <div class="list-main">
            <div class="main-left">
            ...
            <div class="main-right">
                <div>
                    <span>￥{{order.is_team=='1'?goods.groupsprice:goods.singleprice}}/{{goods.goodsnum>1?goods.goodsnum:''}}{{goods.units}}</span>
                </div>
                <div>x 1</div>
            </div>
        </div>
