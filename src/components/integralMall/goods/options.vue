<template>
    <div class="content">
        <div class="content-top">
            ...
            <div class="top-right">
            	<div v-if="select!=-1">￥{{money}}+{{credit}}积分</div>
                <div v-else>￥{{goods.minmoney}}+{{goods.mincredit}}积分</div>
        ...
        <div class="content-col">
            <div class="col-title">规格</div>
            <div class="col-btns">
                <div v-for="(v,i) in options" :key="i" class="btns" :class="{'active': select==i}" @click="isActive(i,v.total,v.title,v.id,v.title,v.money,v.credit)">{{v.title}}</div>
            </div>
        </div>
...
//                type: Object,
        ...
        methods: {
            isActive(e,tot,til,id,title,money,credit){
            	console.log('e',e);
                let that = this;
                that.id=id;
                that.total=tot;
