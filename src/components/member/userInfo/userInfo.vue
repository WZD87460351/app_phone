 <template>
    ...
    <div class="main">
        ...
        <div class="container">
            <ul class="userinfo-list">
                ...
                <li class="cell">
                    ...
                    <input type="search" name="" class="right" v-model="member.realname" placeholder="请输入真实姓名">
                </li>
        ...
        <!-- 所在城市 -->
        <mt-popup v-model="mypopup" position="bottom" class="cityPopup" style="z-index: 3000">
            <div class="userpopup">
        ...
        methods:{
            postUserInfo(){
                ...
                let params={
                    ...
                    'memberdata[nickname]':_this.member.nickname
                }
                util.request({
