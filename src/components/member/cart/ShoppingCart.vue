  ...
  <div class="content">
    ...
    <div class="container">
        <div class="goods-content" v-show="getShCartData.length">
          <!--<ul class="goods-list">-->
            <cart :getShCartDatas="getShCartData"></cart>
            <!--<li class="clearfix" v-for="(v,i) in getShCartData" :key="i">-->
            <!--&lt;!&ndash; <li class="clearfix" v-for="(v,i) in info.activityList" :key="i"> &ndash;&gt;-->
              ...
              <!--<div @click="goProductDetail(v)">-->
                ...
                <!--<div class="goods-info fl">-->
                  ...
                  <!--</div>-->
                  <!--&lt;!&ndash;<div class="goods-num">X<i>{{v.total}}</i></div>&ndash;&gt;-->
                <!--</div>-->
              <!--</div>-->
