        ...
        <div class="container">
            <ul>
                ...
                <li>
                    ...
                    <p class="right" @click="typeTap"><span>{{type}}</span><span class="iconfont">&#xe61b;</span></p>
                </li>
                <li v-if="typeId==2">
                    <span class="title">姓名</span><input class="right" type="text" placeholder="请输入姓名"
                                                        v-model="realname"/>
                </li>
                <li v-if="typeId==2">
                    <span class="title">支付宝账号</span><input class="right" type="text" placeholder="请输入支付宝账号"
                                                           v-model="alipay"/>
                </li>
                <li v-if="typeId==2">
                    <span class="title">确认账号</span><input class="right" type="text" placeholder="请输入支付宝账号"
                                                          v-model="alipay1"/>
                </li>
                <li v-if="typeId==3">
                    <span class="title">选择银行</span>
                    <p class="right" @click="bankTap"><span>{{bankname}}</span><span class="iconfont">&#xe61b;</span>
                    </p>
                </li>
                <li v-if="typeId==3">
                    <span class="title">姓名</span><input class="right" type="text" placeholder="请输入姓名"
                ...
                <li v-if="typeId==3">
                    <span class="title">银行卡号</span><input class="right" type="text" placeholder="请输入银行卡号"
                                                          v-model="bankcard"/>
                </li>
                <li v-if="typeId==3">
                    <span class="title">确认卡号</span><input class="right" type="text" placeholder="请输入银行卡号"
                                                          v-model="bankcard1"/>
                </li>
            </ul>
            ...
            init() {
                ...
                util.request({
                    ...
                    success(res) {
                        ...
                        _this.typeSlots[0].values = res.data.type_array.length > 0 ? res.data.type_array : '';
                        _this.bankSlots[0].values = res.data.banklist.length > 0 ? res.data.banklist : '';
                        _this.bankname = res.data.banklist.lenth > 0 ? res.data.banklist[0].bankname : '';
                    }
                })
            },
            typeTap() {//提现方式
